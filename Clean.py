...
class DataCLean:
    ...
    def removeStopWords(self,text):
        ...
        stop_words = self.read_stopwords("dataFiles\\stopWords.txt")
    ...
    def remove_stopwords(self, df_punc_remove):
        # stop_words = set(stopwords.words('english'))
        li_stopwords = self.read_stopwords("dataFiles\\stopWords.txt")
        # print(stop_words)
        count_clean = 0
    ...
    def Clean(self):
        ...
        final_df, df = self.extract('dataFiles\\Training.csv')
